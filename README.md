...
- **当前进度**：
  - 阶段一（OpenHarmony / Hi3861）：任务 3 / 4 / 5 完成（共 10 个任务）
  - 阶段三（STM32）：任务 19（串口收发 + WS2812 炫彩灯）、任务 21（PWM 驱动电机）完成
...
3. 串口助手（115200）观察 `Hello World!` / `Hello QST!` 交替打印。

> 详细步骤与踩坑记录见各子目录 README：
> - [`hi3861/README.md`](hi3861/README.md) —— Hi3861 任务5 编译 / 烧录 / 踩坑
...
- [2026-08-26](diary/2026-08-26.md)：任务3/4/5（OpenHarmony 环境 + Hello World 烧录）与任务21（PWM 电机）完成

## 后续计划

- 阶段一任务 6~10：红外对管收发、GPIO 驱动舵机、GPIO 驱动超声波、UART 信息收发、阶段综合实验
- 阶段三任务 22~28：NFC 读卡、更多传感器与运动控制
